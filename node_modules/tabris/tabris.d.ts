// Type definitions for Tabris.js 3.2.1
 ...
 */
 export class ImageBitmap {
   ...
   * @param image The data source to create an ImageBitmap instance from.
   */
  static createImageBitmap(image: Blob | ImageData | ImageBitmap): Promise<ImageBitmap>;
